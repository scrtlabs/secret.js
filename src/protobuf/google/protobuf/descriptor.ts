...
export const FieldOptions = {
  ...
  fromJSON(object: any): FieldOptions {
    return {
      ...
      targets: Array.isArray(object?.targets)
        ...
        : [],
      edition_defaults: Array.isArray(object?.edition_defaults)
  ...
  toJSON(message: FieldOptions): unknown {
    ...
    message.debug_redact !== undefined &&
    ...
    if (message.edition_defaults) {
      ...
      obj.edition_defaults = [];
    }
    message.features !== undefined &&
      (obj.features = message.features
        ? FeatureSet.toJSON(message.features)
        : undefined);
    message.feature_support !== undefined &&
      (obj.feature_support = message.feature_support
        ? FieldOptions_FeatureSupport.toJSON(message.feature_support)
        : undefined);
    if (message.uninterpreted_option) {
      obj.uninterpreted_option = message.uninterpreted_option.map((e) =>
        e ? UninterpretedOption.toJSON(e) : undefined,
...
export const FieldOptions_FeatureSupport = {
  encode(
    ...
    if (message.edition_introduced !== 0) {
      writer.uint32(8).int32(message.edition_introduced);
    }
    if (message.edition_deprecated !== 0) {
  ...
  fromJSON(object: any): FieldOptions_FeatureSupport {
    return {
      ...
      deprecation_warning: isSet(object.deprecation_warning)
        ? String(object.deprecation_warning)
        : "",
...
export const FeatureSetDefaults_FeatureSetEditionDefault = {
  ...
  toJSON(message: FeatureSetDefaults_FeatureSetEditionDefault): unknown {
    ...
    message.edition !== undefined &&
      (obj.edition = editionToJSON(message.edition));
    message.overridable_features !== undefined &&
      (obj.overridable_features = message.overridable_features
        ? FeatureSet.toJSON(message.overridable_features)
        : undefined);
    message.fixed_features !== undefined &&
      (obj.fixed_features = message.fixed_features
        ? FeatureSet.toJSON(message.fixed_features)
        : undefined);
    return obj;
  },
