...
export const Proposal = {
  ...
  fromJSON(object: any): Proposal {
    return {
      ...
      failed_reason: isSet(object.failed_reason)
        ? String(object.failed_reason)
        : "",
    };
  },
  ...
  toJSON(message: Proposal): unknown {
    ...
    message.failed_reason !== undefined &&
...
export const Params = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11:
          ...
          break;
        case 12:
          message.expedited_min_deposit.push(
  ...
  fromJSON(object: any): Params {
    return {
      ...
      min_initial_deposit_ratio: isSet(object.min_initial_deposit_ratio)
        ...
        : "",
      proposal_cancel_ratio: isSet(object.proposal_cancel_ratio)
        ? String(object.proposal_cancel_ratio)
        : "",
      proposal_cancel_dest: isSet(object.proposal_cancel_dest)
        ? String(object.proposal_cancel_dest)
        : "",
      ...
      expedited_threshold: isSet(object.expedited_threshold)
        ? String(object.expedited_threshold)
        : "",
      expedited_min_deposit: Array.isArray(object?.expedited_min_deposit)
      ...
      burn_vote_veto: isSet(object.burn_vote_veto)
        ? Boolean(object.burn_vote_veto)
        : false,
      min_deposit_ratio: isSet(object.min_deposit_ratio)
        ? String(object.min_deposit_ratio)
        : "",
    };
  },
  ...
  toJSON(message: Params): unknown {
    ...
    message.proposal_cancel_ratio !== undefined &&
      (obj.proposal_cancel_ratio = message.proposal_cancel_ratio);
    message.proposal_cancel_dest !== undefined &&
    ...
    if (message.expedited_min_deposit) {
      obj.expedited_min_deposit = message.expedited_min_deposit.map((e) =>
        e ? Coin.toJSON(e) : undefined,
      );
    } else {
      obj.expedited_min_deposit = [];
    }
    message.burn_vote_quorum !== undefined &&
      (obj.burn_vote_quorum = message.burn_vote_quorum);
    message.burn_proposal_deposit_prevote !== undefined &&
      (obj.burn_proposal_deposit_prevote =
        message.burn_proposal_deposit_prevote);
    message.burn_vote_veto !== undefined &&
      (obj.burn_vote_veto = message.burn_vote_veto);
    message.min_deposit_ratio !== undefined &&
  ...
  fromPartial(object: DeepPartial<Params>): Params {
    ...
    message.expedited_min_deposit =
      object.expedited_min_deposit?.map((e) => Coin.fromPartial(e)) || [];
    message.burn_vote_quorum = object.burn_vote_quorum ?? false;
    message.burn_proposal_deposit_prevote =
      object.burn_proposal_deposit_prevote ?? false;
