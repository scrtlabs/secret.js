...
export const Permissions = {
  ...
  fromJSON(object: any): Permissions {
    return {
      ...
      limit_type_urls: Array.isArray(object?.limit_type_urls)
        ? object.limit_type_urls.map((e: any) => String(e))
        : [],
    };
  },
...
export const GenesisState = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GenesisState {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.account_permissions.push(
  ...
  fromJSON(object: any): GenesisState {
    return {
      account_permissions: Array.isArray(object?.account_permissions)
        ? object.account_permissions.map((e: any) =>
            GenesisAccountPermissions.fromJSON(e),
          )
        : [],
      disabled_type_urls: Array.isArray(object?.disabled_type_urls)
        ? object.disabled_type_urls.map((e: any) => String(e))
        : [],
    };
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.account_permissions) {
      obj.account_permissions = message.account_permissions.map((e) =>
