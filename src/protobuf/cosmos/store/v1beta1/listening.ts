...
export const BlockMetadata = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BlockMetadata {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 6:
          message.response_commit = ResponseCommit.decode(
            reader,
            reader.uint32(),
          );
          break;
        case 7:
          message.request_finalize_block = RequestFinalizeBlock.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromJSON(object: any): BlockMetadata {
    return {
      response_commit: isSet(object.response_commit)
  ...
  toJSON(message: BlockMetadata): unknown {
    const obj: any = {};
    message.response_commit !== undefined &&
      (obj.response_commit = message.response_commit
        ? ResponseCommit.toJSON(message.response_commit)
        : undefined);
    message.request_finalize_block !== undefined &&
      (obj.request_finalize_block = message.request_finalize_block
        ? RequestFinalizeBlock.toJSON(message.request_finalize_block)
        : undefined);
  ...
  fromPartial(object: DeepPartial<BlockMetadata>): BlockMetadata {
    const message = createBaseBlockMetadata();
    message.response_commit =
      object.response_commit !== undefined && object.response_commit !== null
