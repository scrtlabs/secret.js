...
export const Validator = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11:
          ...
          break;
        case 12:
          message.unbonding_on_hold_ref_count = longToString(
  ...
  fromJSON(object: any): Validator {
    return {
      ...
      unbonding_on_hold_ref_count: isSet(object.unbonding_on_hold_ref_count)
        ...
        : "0",
      unbonding_ids: Array.isArray(object?.unbonding_ids)
        ? object.unbonding_ids.map((e: any) => String(e))
        : [],
    };
  },
  ...
  toJSON(message: Validator): unknown {
    ...
    message.unbonding_on_hold_ref_count !== undefined &&
  ...
  fromPartial(object: DeepPartial<Validator>): Validator {
    ...
    message.unbonding_on_hold_ref_count =
      object.unbonding_on_hold_ref_count ?? "0";
...
export const UnbondingDelegationEntry = {
  ...
  fromJSON(object: any): UnbondingDelegationEntry {
    return {
      ...
      unbonding_id: isSet(object.unbonding_id)
        ? String(object.unbonding_id)
        : "0",
      unbonding_on_hold_ref_count: isSet(object.unbonding_on_hold_ref_count)
        ? String(object.unbonding_on_hold_ref_count)
        : "0",
  ...
  toJSON(message: UnbondingDelegationEntry): unknown {
    ...
    message.unbonding_id !== undefined &&
