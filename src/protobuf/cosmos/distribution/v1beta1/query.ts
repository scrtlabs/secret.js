...
export const QueryRestakeEntriesRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryRestakeEntriesRequest>,
  ): QueryRestakeEntriesRequest {
    const message = createBaseQueryRestakeEntriesRequest();
...
export const QueryRestakingEntriesResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryRestakingEntriesResponse>,
  ): QueryRestakingEntriesResponse {
    const message = createBaseQueryRestakingEntriesResponse();
...
export const QueryRestakeThresholdRequest = {
  ...
  fromPartial(
    _: DeepPartial<QueryRestakeThresholdRequest>,
  ): QueryRestakeThresholdRequest {
    const message = createBaseQueryRestakeThresholdRequest();
    return message;
  },
...
export const QueryRestakeThresholdResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryRestakeThresholdResponse>,
  ): QueryRestakeThresholdResponse {
    const message = createBaseQueryRestakeThresholdResponse();
...
export const QueryValidatorDistributionInfoResponse = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.self_bond_rewards.push(
  ...
  toJSON(message: QueryValidatorDistributionInfoResponse): unknown {
    ...
    if (message.self_bond_rewards) {
      obj.self_bond_rewards = message.self_bond_rewards.map((e) =>
  ...
  fromPartial(
    ...
    message.self_bond_rewards =
      object.self_bond_rewards?.map((e) => DecCoin.fromPartial(e)) || [];
    message.commission =
...
export const QueryFoundationTaxRequest = {
  ...
  fromPartial(
    _: DeepPartial<QueryFoundationTaxRequest>,
  ): QueryFoundationTaxRequest {
    const message = createBaseQueryFoundationTaxRequest();
    return message;
  },
...
export const QueryFoundationTaxResponse = {
  encode(
    message: QueryFoundationTaxResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    if (message.tax !== "") {
  ...
  fromPartial(
    object: DeepPartial<QueryFoundationTaxResponse>,
  ): QueryFoundationTaxResponse {
    const message = createBaseQueryFoundationTaxResponse();
