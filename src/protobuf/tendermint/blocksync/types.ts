...
export const BlockResponse = {
  ...
  fromJSON(object: any): BlockResponse {
    return {
      ...
      ext_commit: isSet(object.ext_commit)
        ? ExtendedCommit.fromJSON(object.ext_commit)
        : undefined,
    };
  },
  ...
  toJSON(message: BlockResponse): unknown {
    ...
    message.ext_commit !== undefined &&
      (obj.ext_commit = message.ext_commit
        ? ExtendedCommit.toJSON(message.ext_commit)
        : undefined);
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<BlockResponse>): BlockResponse {
    ...
    message.block =
      object.block !== undefined && object.block !== null
        ...
        : undefined;
    message.ext_commit =
      object.ext_commit !== undefined && object.ext_commit !== null
