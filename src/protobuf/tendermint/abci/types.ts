...
import { Commit, EncryptedRandom } from "../types/types";
...
export interface RequestFinalizeBlock {
  ...
  proposer_address: Uint8Array;
  /** a random number encrypted by the proposer to be used in contracts */
...
export const RequestFinalizeBlock = {
  encode(message: RequestFinalizeBlock, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.encrypted_random !== undefined) {
      EncryptedRandom.encode(message.encrypted_random, writer.uint32(74).fork()).ldelim();
    }
    if (message.commit !== undefined) {
      Commit.encode(message.commit, writer.uint32(82).fork()).ldelim();
    }
    return writer;
  },
