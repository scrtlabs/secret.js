...
export const ExtendedCommit = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.extended_signatures.push(
  ...
  fromJSON(object: any): ExtendedCommit {
    return {
      ...
      block_id: isSet(object.block_id)
        ? BlockID.fromJSON(object.block_id)
        : undefined,
      extended_signatures: Array.isArray(object?.extended_signatures)
        ? object.extended_signatures.map((e: any) =>
  ...
  toJSON(message: ExtendedCommit): unknown {
    ...
    if (message.extended_signatures) {
      obj.extended_signatures = message.extended_signatures.map((e) =>
  ...
  fromPartial(object: DeepPartial<ExtendedCommit>): ExtendedCommit {
    ...
    message.block_id =
      object.block_id !== undefined && object.block_id !== null
        ? BlockID.fromPartial(object.block_id)
        : undefined;
    message.extended_signatures =
      object.extended_signatures?.map((e) =>
        ExtendedCommitSig.fromPartial(e),
      ) || [];
    return message;
  },
};
