...
export const Allocation = {
  ...
  fromJSON(object: any): Allocation {
    return {
      ...
      allow_list: Array.isArray(object?.allow_list)
        ...
        : [],
      allowed_packet_data: Array.isArray(object?.allowed_packet_data)
        ? object.allowed_packet_data.map((e: any) => String(e))
        : [],
    };
  },
  ...
  fromPartial(object: DeepPartial<Allocation>): Allocation {
    ...
    message.allowed_packet_data =
      object.allowed_packet_data?.map((e) => e) || [];
    return message;
  },
};
