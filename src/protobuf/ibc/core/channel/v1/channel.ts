...
export const Params = {
  ...
  fromJSON(object: any): Params {
    return {
      upgrade_timeout: isSet(object.upgrade_timeout)
        ? Timeout.fromJSON(object.upgrade_timeout)
        : undefined,
    };
  },
  ...
  toJSON(message: Params): unknown {
    const obj: any = {};
    message.upgrade_timeout !== undefined &&
      (obj.upgrade_timeout = message.upgrade_timeout
        ? Timeout.toJSON(message.upgrade_timeout)
        : undefined);
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<Params>): Params {
    const message = createBaseParams();
    message.upgrade_timeout =
      object.upgrade_timeout !== undefined && object.upgrade_timeout !== null
