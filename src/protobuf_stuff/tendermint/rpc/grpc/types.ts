...
export interface BroadcastAPI {
  ping(
    request: DeepPartial<RequestPing>,
    metadata?: grpc.Metadata,
  ): Promise<ResponsePing>;
  broadcastTx(
    request: DeepPartial<RequestBroadcastTx>,
    metadata?: grpc.Metadata,
  ): Promise<ResponseBroadcastTx>;
}
...
export class BroadcastAPIClientImpl implements BroadcastAPI {
  ...
  ping(
    ...
    return this.rpc.unary(
      BroadcastAPIPingDesc,
      RequestPing.fromPartial(request),
      metadata,
    );
  }
  ...
  broadcastTx(
    ...
    return this.rpc.unary(
      BroadcastAPIBroadcastTxDesc,
      RequestBroadcastTx.fromPartial(request),
      metadata,
    );
  }
}

export const BroadcastAPIDesc = {
...
export const BroadcastAPIBroadcastTxDesc: UnaryMethodDefinitionish = {
  ...
  responseType: {
    deserializeBinary(data: Uint8Array) {
      return {
        ...ResponseBroadcastTx.decode(data),
        toObject() {
          return this;
        },
      };
